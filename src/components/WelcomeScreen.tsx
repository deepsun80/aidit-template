...
export default function WelcomeScreen({
  ...
  const hasQuestions = report?.questions?.length > 0;
  const hasResponses = report?.qaList?.length > 0;
    ...
    <div className='text-center text-gray-700 text-lg'>
      ...
      {!hasReport && (
        <>
          ...
          <p>You have no reports in your account.</p>
          <p className='mt-2'>
            <span className='text-gray-900 font-medium'>
              Start by <span className='font-bold'>creating a new report:</span>
            </span>
          </p>
